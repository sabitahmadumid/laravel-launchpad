...
@section('title', __('launchpad::update.update_in_progress'))
...
<div x-data="updateRunner()" class="space-y-6">
    <div class="bg-white rounded-lg shadow-sm p-8">
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-4">{{ __('launchpad::update.update_title') }}</h2>
            <p class="text-lg text-gray-600">
                {{ __('launchpad::update.update_description') }}
            </p>
        </div>
        ...
        <form @submit.prevent="runUpdate()" class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    ...
                    {{ __('launchpad::update.update_options') }}
                </h3>
